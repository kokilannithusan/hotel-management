...
export const HallManagement: React.FC = () => {
  ...
  const hallStats = {
    ...
    averagePrice:
      halls.length > 0
        ? halls.reduce((sum, h) => sum + h.pricePerHour, 0) / halls.length
        : 0,
  };
        ...
        <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white border-0">
          <div className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm opacity-90">Total Halls</p>
                <p className="text-3xl font-bold">{hallStats.total}</p>
              </div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{hallStats.available}</p>
              </div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold">{hallStats.totalCapacity}</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {formatCurrency(hallStats.averagePrice)}
                </p>
              </div>
